...
pleine dimension à un coût de requête ${\sim}90\times$ moindre. Notre contribution
est le modèle de mémoire multi-résolution et explicable ainsi qu'une caractérisation
honnête de sa plage de fonctionnement, livrés comme un artefact propre et
reproductible -- et non le pipeline de projection sous-jacent, que nous attribuons
aux travaux antérieurs~\cite{octreerag}.
\end{abstract}
