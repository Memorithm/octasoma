...
query cost. Our contribution is the multi-resolution, explainable memory model and
an honest characterisation of its operating range, delivered as a clean
reproducible artifact -- not the underlying projection pipeline, which we
